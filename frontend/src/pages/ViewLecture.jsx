    ...
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col md:flex-row gap-6">
      ...
      <div className=" w-full md:w-2/3 bg-white rounded-2xl shadow-md p-6 border border-gray-200 ">
        <div className=" mb-6">
          ...
          <div className=" mt-2 flex gap-4 text-sm font-medium text-gray-500 ">
          ...
          {selectedCourse?.lectures?.length > 0 ? (
            selectedCourse?.lectures?.map((lecture, index) => (
              <button
                ...
                key={index}
                className={`flex flex- items-center justify-between p-3 rounded-lg border transition text-left ${
