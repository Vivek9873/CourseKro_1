...
import AboutVideo from "../assets/courekro_logo_intro.mp4";
...
function About() {
  return (
    <div className=" w-[100vw] lg:h-[70vh] min-h-[50vh] flex flex-wrap items-center justify-center gap-2 mb-[30px] ">
      {/* for image  */}
      <div className=" lg:w-[40%] md:w-[80%] w-[90%] h-[100%] flex items-center justify-center relative ">
        <img src={AboutImg} alt="" className=" w-[80%] h-[90%] rounded-lg " />
        <div className=" max-w-[350px] mx-auto p-4 absolute top-[45%] left-[50%] ">
          <video
            src={AboutVideo}
